...
/**
 * Servlet implementation class oldhumidity
 */
@WebServlet("/oldhumidity")
public class oldhumidity extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "select collectionData  from  t_humidity order by COLLECTIONTIME asc ";
